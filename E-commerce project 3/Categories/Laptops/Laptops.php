...
$query="SELECT * FROM product WHERE categorie='pc' ";
...
<body>
    ...
    <div class="section"><span style="font-size:16px; font-weight:400;"><a href="../TVs/TVs.php">TVs</a></span><span>Laptops</span><span style="font-size:16px; font-weight:400;"><a href="../Phones/Phones.php">Mobile</a></span></div>
  <div class="container"> 
    <div class="cards">
  ...
  <?php foreach($products as $product):?>
        ...
        <div class="card">
            <a href="../../item description page/Laptops/pc.php?id=<?php echo $product['id'] ?>"><img src="<?php echo $product['path'] ?>" alt=""></a> 
