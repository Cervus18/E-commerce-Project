...
$query="SELECT * FROM product WHERE categorie='tv' ";
...
<body>
  ...
  <div class="section"><span style="font-size:16px; font-weight:400;"><a href="../Phones/Phones.php">Mobile</a></span><span>TVs</span><span style="font-size:16px; font-weight:400;"><a href="../Laptops/Laptops.php">Laptops</a></span></div>
  ...
  <div class="container">
    ...
    <?php foreach($products as $product):?>
        ...
        <div class="card">
            <a href="../../item description page/TVs/tv.php?id=<?php echo $product['id'] ?>"><img src="<?php echo $product['path'] ?>" alt=""></a> 
